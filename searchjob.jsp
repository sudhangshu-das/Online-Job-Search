...
<body><form name="form1" method="post" action="jobsearch1.jsp">
...
<td width="696" align="left" valign="top" bgcolor="#FFFFFF"><p align="right" class="style10" __designer:dtid="1688858450198550">&nbsp;</p>
  <p align="right" class="style10" __designer:dtid="1688858450198550">&nbsp;</p>
  <p align="right" class="style10" __designer:dtid="1688858450198550"><strong>Enter Your Candidate Id</strong> 
