...
<p>
 ...
 String det=request.getParameter("textarea");
  String type=request.getParameter("select4");
  
  
 Class.forName("com.mysql.jdbc.Driver");
		  Connection connection = DriverManager.getConnection("jdbc:mysql://localhost/jobs","root","1234");
		  Statement statement = connection.createStatement();
String query="insert into candidates values('"+id+"','"+name+"','"+address+"','"+city+"','"+state+"','"+email+"','"+phone+"','"+dob+"','"+age+"','"+qual+"','"+cer+"','"+status+"','"+exp+"','"+mstatus+"','"+skill+"','"+sal+"','"+det+"','"+type+"')";
 ...
 %>
  <jsp:forward page="candidatedetail.jsp" />
  </p>
<p>&nbsp;</p>
</body>
</html>
