  ...
  <tr>
    ...
    <th width="645" align="left" valign="top" scope="col"><p>&nbsp;</p>
        <table width="618" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <th width="618" height="375" align="left" valign="top" scope="col"><h2 align="center" class="style8">CANDIDATES DETAILS AS PER  QUALIFICATION </h2>
                <% 
			 
		 String qual=request.getParameter("textfield2");
		  Class.forName("com.mysql.jdbc.Driver");
Connection connection = DriverManager.getConnection("jdbc:mysql://localhost/jobs","root","1234");
		  Statement statement = connection.createStatement();

	 
  String query="select * from candidates where qual='"+qual+"'";
...
<table width="946" align="center" bordercolor="#000000">
  <tr>
