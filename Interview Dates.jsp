...
<td width="750" align="left" valign="top" bgcolor="#FFFFFF"><form name="form" method="post" onSubmit="return validate(this)" action="addinterview.jsp">
  <table width="673" height="483" border="0">
    ...
    <tr><% String type=request.getParameter("job"); %>
      <td>&nbsp;</td>
    ...
    <tr>
      ...
      <td><label>
        <input name="textfield9" type="text" readonly="true"  value='<%=type%>'>
      </label></td>
    </tr>
    <tr>
      <td>&nbsp;</td>
