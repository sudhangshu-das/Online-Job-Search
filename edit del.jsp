  ...
  <tr>
    ...
    <th width="645" align="left" valign="top" scope="col"><p>&nbsp;</p>
      <table width="618" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <th width="618" height="375" align="left" valign="top" scope="col"><h2 align="center" class="style8">Edit/Delete Authentication Details </h2>
            <%
...
<td><strong><a href="Edit.jsp?id=<%=rs.getString(1)%>">Edit</a></strong></td>
<td><strong><a href="delete.jsp?id=<%=rs.getString(1)%>">Delete</a></strong></td>
