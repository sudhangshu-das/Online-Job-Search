...
<table width="931" border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <th width="721" align="left" valign="top" scope="col"><p>&nbsp;</p>
      <table width="716" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <th width="618" height="163" align="left" valign="top" scope="col"><h2 align="center" class="style8">*JOB DETAILS ACCORDING TO QUALIFICATION.* </h2>
            <%
...
Connection connection = DriverManager.getConnection("jdbc:mysql://localhost/jobs","root","1234");
  ...
  String query="select * from company where qual='"+qual+"'";
