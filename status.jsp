...
Connection connection = DriverManager.getConnection("jdbc:mysql://localhost/jobs","root","1234");
  ...
  String query="select * from company where id='"+id1+"'";
...
%>
<tr>
  <td><a href="Edit companydetail.jsp?cod=<%=rs.getString(1)%>">Edit</a> </td>
  <td><a href="delete comp.jsp?cod1=<%=rs.getString(1)%>">Delete</a></td>
